    ...
    public static class WindowsPseudoTerminal
    {
            ...
            int timeoutMilliseconds)
        {
            ...
            try
            {
                ...
                // Invalid standard-handle sentinels prevent CreateProcessW from
                // duplicating redirected parent pipes while allowing ConPTY to install
                // the requested process's console handles.
                startupInfo.StartupInfo.dwFlags = StartfUseStdHandles;
                startupInfo.StartupInfo.hStdInput = InvalidHandleValue;
                startupInfo.StartupInfo.hStdOutput = InvalidHandleValue;
                startupInfo.StartupInfo.hStdError = InvalidHandleValue;
