...
The current lifecycle is **55 done, 5 development, and 3 backlog**.
...
- [T051: Windows MCP Provider-Failure Test Stack](development/T051_windows_mcp_provider_failure_stack.md)
- [T052: Windows TUI Session Cache Refresh](development/T052_windows_tui_session_cache_refresh.md)
